/**
 * The "Connection" panel of the Bot settings card: bot token, admin allowlist
 * and public URL. Presentational — every draft value, setter and the busy flag
 * are owned by the card and passed in; this component only renders the fields
 * and wires the admin add/remove callbacks.
 */
